...
export const HeaderOne: FC<Props> = ({
  ...
  return (
    <h1 className={'font-black break-words'} {...props} id={name}>
...
export const HeaderTwo: FC<Props> = ({
  ...
  return (
    <h2 className="mt-20 mb-8 font-black break-words" {...props} id={name}>
      <AnchorChildren name={name} isAnchored={isAnchored}>
        {children}
      </AnchorChildren>
    </h2>
...
export const HeaderThree: FC<Props> = ({
  ...
  return (
    <h3 className="mt-12 mb-4 font-black break-words" {...props} id={name}>
      <AnchorChildren name={name} isAnchored={isAnchored}>
        {children}
      </AnchorChildren>
    </h3>
